...
myMasterTabbed  = renamed [Replace "MTABBED" ]
                $ avoidStruts
                $ myTopBar
                $ mySpacings
                $ myGaps
...
myThreeColP     = renamed [Replace "THREECOL"]
                $ myTopBar
                $ mySpacings
                $ myGaps
...
myMosic         =  renamed [Replace "MOSIC"] 
                $ myTopBar
                $ myGaps
                $ mySpacings
                $ mosaic 2 [3,2]

mySimpleFloat   =  renamed [Replace "SFLOAT"]       
                $ myGaps
                $ myTopBar
                $ simplestFloat

myRefTall       = renamed [Replace "REFTALL"]
                $ myTopBar
	            $ mySpacings
                $ myGaps
                $ reflectHoriz
...
myTiledP        = renamed [Replace "TILED"]
                $ myTopBar
                $ mySpacings
                $ myGaps
                $ consoleOn
...
---------------------------------------------------------------------
myBordercrossing = renamed [Replace "BORDERCR"]
                 $ combineTwoP (TwoPane 0.03 (3/4))
                            (myRefTall)
                            (myTabbed)
                            (ClassName "firefox")

myOneUp         = renamed [Replace "1UP"]
                $ myGaps
                $ mySpacings
...
myMultipassA    = renamed [ Replace "MULTIPASSA"]
                $ mySpacings
                $ myGaps
